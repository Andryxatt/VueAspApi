        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    isApplayed = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SizeUS = table.Column<string>(nullable: true),
                    SizeUK = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberBuiding = table.Column<string>(nullable: true),
                    NumberAppartments = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AddressOrders_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PriceSalleUS = table.Column<float>(nullable: false),
                    PriceSalleUAH = table.Column<float>(nullable: false),
                    CountBoxes = table.Column<int>(nullable: true),
                    CountPairsInBox = table.Column<int>(nullable: true),
                    SizesInBox = table.Column<string>(nullable: true),
                    BrandId = table.Column<Guid>(nullable: true),
                    SubId = table.Column<Guid>(nullable: true),
                    isDiscount = table.Column<bool>(nullable: false),
                    DiscountUS = table.Column<int>(nullable: true),
                    DiscountUAH = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SelectedSizeId = table.Column<Guid>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CartProduct_ProdSizes_SelectedSizeId",
                        column: x => x.SelectedSizeId,
                        principalTable: "ProdSizes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });

            migrationBuilder.CreateIndex(
                name: "IX_AddressOrders_OrderId",
                table: "AddressOrders",
                column: "OrderId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CartProduct_SelectedSizeId",
                table: "CartProduct",
